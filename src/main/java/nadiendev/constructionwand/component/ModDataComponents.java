...
public class ModDataComponents
{
    ...
    public static final Supplier<DataComponentType<WandOptions.LOCK>> LOCK =
            DATA_COMPONENT_TYPES.register("lock", () ->
    ...
    public static final Supplier<DataComponentType<WandOptions.DIRECTION>> DIRECTION =
            DATA_COMPONENT_TYPES.register("direction", () ->
    ...
    public static final Supplier<DataComponentType<Boolean>> REPLACE =
            DATA_COMPONENT_TYPES.register("replace", () ->
                    DataComponentType.<Boolean>builder()
                            .persistent(Codec.BOOL)
                            .networkSynchronized(ByteBufCodecs.BOOL)
                            .build());

    public static final Supplier<DataComponentType<WandOptions.MATCH>> MATCH =
            DATA_COMPONENT_TYPES.register("match", () ->
    ...
    public static final Supplier<DataComponentType<Boolean>> RANDOM =
            DATA_COMPONENT_TYPES.register("random", () ->
                    DataComponentType.<Boolean>builder()
                            .persistent(Codec.BOOL)
                            .networkSynchronized(ByteBufCodecs.BOOL)
                            .build());

    public static final Supplier<DataComponentType<CompoundTag>> CORES =
            DATA_COMPONENT_TYPES.register("cores", () ->
