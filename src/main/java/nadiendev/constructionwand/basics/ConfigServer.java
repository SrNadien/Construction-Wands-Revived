...
public class ConfigServer
{
    ...
    static {
        ...
        new WandProperties(builder, ModItems.WAND_WOOD, ToolMaterial.WOOD.durability(), 5, 0, 0, false);
        ...
        new WandProperties(builder, ModItems.WAND_GOLD, ToolMaterial.GOLD.durability(), 60, 5, 15, true);
