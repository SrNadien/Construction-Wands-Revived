...
public class ModRecipes
{
    ...
    public static final Supplier<RecipeSerializer<RecipeWandUpgrade>> WAND_UPGRADE = RECIPE_SERIALIZERS.register("wand_upgrade", () -> new CustomRecipe.Serializer<>(RecipeWandUpgrade::new));
}
