...
public class HandlerWirelessTerminal implements IContainerHandler {
    ...
    private WirelessTerminalMenuHost<?> getHost(ServerPlayer player, ItemStack terminal) {
        try {
            ...
            if (!(terminal.getItem() instanceof WirelessTerminalItem wirelessItem)) return null;

            WirelessTerminalMenuHost<?> host = wirelessItem.getMenuHost(player, locator, null);
